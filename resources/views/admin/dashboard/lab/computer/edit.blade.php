<!-- resources/views/admin/dashboard/lab/computer/edit.blade.php -->
<!DOCTYPE html>
<html lang="id">
...
<body>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="form-card">
                    <form action="{{ route('admin.computer.update', [$lab->labID, $computer->computerID]) }}"
                        method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="computerName" id="computerName"
                                ...
                                value="{{ old('computerName', $computer->computerName) }}" required>
                        ...
                        <div class="mb-3">
                            ...
                            <select name="status" id="status" class="form-select @error('status') is-invalid @enderror"
                                required>
                                <option value="Active" {{ old('status', $computer->status) == 'Active' ? 'selected' : '' }}>
                                    Active</option>
                                <option value="Inactive" {{ old('status', $computer->status) == 'Inactive' ? 'selected' : '' }}>Inactive</option>
                            </select>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" name="storage" id="storage"
                                ...
                                value="{{ old('storage', $computer->storage) }}" required>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="OS" id="OS" class="form-control @error('OS') is-invalid @enderror"
                                value="{{ old('OS', $computer->OS) }}" required>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="CPU" id="CPU"
                                ...
                                value="{{ old('CPU', $computer->CPU) }}" required>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="GPU" id="GPU"
                                ...
                                value="{{ old('GPU', $computer->GPU) }}" required>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" name="RAM" id="RAM"
                                ...
                                value="{{ old('RAM', $computer->RAM) }}" required>
