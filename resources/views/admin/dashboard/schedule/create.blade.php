...
<head>
    ...
    <title>Add New Schedule - Lab Management</title>
...
<body>
    ...
    <div class="page-header">
        <div class="container">
            <h2><i class="bi bi-plus-circle me-2"></i>Add New Schedule</h2>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" style="color: white;">Add Schedule</li>
                </ol>
            </nav>
        </div>
    </div>
